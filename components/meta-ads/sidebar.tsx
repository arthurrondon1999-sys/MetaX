...
export function MetaAdsSidebar({ activePage = "meta-ads" }: SidebarProps) {
  return (
    <motion.aside
          ...
          <div className="relative">
            ...
            >
              <path
                ...
                fill="url(#sidebarHexGradient2)"
                fillOpacity="0.2"
                stroke="url(#sidebarHexStroke2)"
                strokeWidth="1.5"
              />
              <path
                d="M14 32V18L24 26L34 18V32"
                stroke="url(#sidebarMGradient2)"
                strokeWidth="2.5"
                strokeLinecap="round"
      ...
      <nav className="flex-1 py-4 px-3 overflow-y-auto">
        <ul className="space-y-1">
          {navItems.map((item, index) => {
            const isActive = item.href === `/${activePage}` || (activePage === "dashboard" && item.href === "/dashboard")
            return (
              <motion.li
                key={item.label}
